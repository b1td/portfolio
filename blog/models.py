...
class Post(models.Model):
    ...
    meta_title = models.CharField(blank=False, null=True, max_length=255)
    meta_description = models.CharField(blank=False, null=True, max_length=500)
    meta_keywords = models.CharField(blank=True, null=True, max_length=500)
    ...
    def get_absolute_url(self):
        return reverse('blog:postDetail', args=[self.slug, self.id])
